...
class SpentIndexTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [["-debug", "-deprecatedrpc=signrawtransaction"],["-debug", "-spentindex", "-deprecatedrpc=signrawtransaction"],["-debug", "-spentindex", "-deprecatedrpc=signrawtransaction"], ["-debug", "-spentindex", "-txindex", "-deprecatedrpc=signrawtransaction"]]
